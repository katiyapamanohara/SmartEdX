      ...
      <div className="flex flex-wrap items-start justify-between gap-5">
        <div>
          ...
          <span className="block text-gray-500 text-theme-sm dark:text-gray-400">
            {selected === "optionOne" && "Visitor analytics of last 30 days"}
            {selected === "optionTwo" && "Visitor analytics of last 7 days"}
            {selected === "optionThree" && "Visitor analytics of last 24 hours"}
          </span>
        </div>
