...
const Notification: React.FC<NotificationProps> = ({
  ...
  // Styling configuration for each alert type with light and dark themes
  const variantStyles = {
    success: {
      borderColor: "border-success-500",
      iconBg: "bg-success-50 text-success-500 dark:bg-success-500/15 dark:text-success-400",
      icon: <CheckCircleIcon />,
    },
    info: {
      borderColor: "border-blue-light-500",
      iconBg: "bg-blue-light-50 text-blue-light-500 dark:bg-blue-light-500/15 dark:text-blue-light-400",
      icon: <InfoIcon />,
    },
    warning: {
      borderColor: "border-warning-500",
      iconBg: "bg-warning-50 text-warning-500 dark:bg-warning-500/15 dark:text-warning-400",
      icon: <AlertIcon />,
    },
    error: {
      borderColor: "border-error-500",
      iconBg: "bg-error-50 text-error-500 dark:bg-error-500/15 dark:text-error-400",
      icon: <ErrorIcon />,
    },
  };
  ...
  return (
    <div
      className={`flex items-center justify-between gap-3 w-full sm:max-w-[340px] rounded-md border-b-4 p-3 shadow-theme-sm bg-white dark:bg-gray-800 ${borderColor}`}
    >
