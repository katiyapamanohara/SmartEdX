        ...
        <div className="grid gap-5 gird-cols-1 sm:grid-cols-2 xl:grid-cols-3 xl:gap-6">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              For early-stage startups & solo founders
            </p>
          ...
          <div className="p-6 bg-gray-800 border border-gray-800 rounded-2xl dark:border-white/10 dark:bg-white/10">
            ...
            <p className="text-sm text-white/70">
              Best for growing teams and expanding operations
            </p>
            ...
            <button className="flex w-full items-center justify-center rounded-lg bg-indigo-500 p-3.5 text-sm font-medium text-white shadow-theme-xs transition-colors hover:indigo-600 dark:hover:bg-indigo-600">
              Choose Medium
            </button>
          </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Perfect for enterprises and advanced automation
            </p>
