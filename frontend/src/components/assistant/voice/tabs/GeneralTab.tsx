...
export const GeneralTab: React.FC<GeneralTabProps> = ({ settings, onChange, onImageChange, saveSuccess, saveError }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-gray-500 mb-2">What name will your assistant go by.</p>
        <input
          type="text"
          name="name"
          value={settings.name}
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mb-2">An optional image that will be displayed in your assistants list.</p>
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 mb-2">Description about your assistant</p>
        <textarea
          name="description"
