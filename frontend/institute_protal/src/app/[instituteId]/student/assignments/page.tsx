  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="py-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Track your pending and submitted assignments</p>
      </div>

      {/* Stat bar */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: "Total Assignments", value: "—" },
          { label: "Pending", value: "—" },
      ...
      <div className="flex flex-col items-center justify-center py-24 rounded-2xl border border-dashed border-gray-200 dark:border-gray-700 bg-white dark:bg-white/[0.03] text-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">Assignments from your courses will appear here.</p>
        </div>
      </div>
    </div>
  );
