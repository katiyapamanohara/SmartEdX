  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="py-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Courses assigned to you — manage modules and content</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {courses.map((course) => (
            <div
              key={course.id}
              className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-white/3 overflow-hidden hover:shadow-md transition-shadow flex flex-col"
            >
              {course.coverImage ? (
