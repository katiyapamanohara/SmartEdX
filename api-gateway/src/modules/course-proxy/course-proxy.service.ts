...
@Injectable()
export class CourseProxyService {
  private readonly serviceUrl = servicesConfig.courseService.url;
  ...
  async proxyRequest(
    ...
    const url = `${this.serviceUrl}${servicesConfig.courseService.prefix}${path}`;
    const config = {
