...
export class InstituteProxyController {
  ...
  @Post(
    'institutes/:id/courses/:courseId/modules/:moduleId/contents/upload-file',
  )
  @ApiOperation({
    summary: 'Upload a file as module content (PDF, document, video)',
  })
  ...
  async uploadContent(
    ...
    return this.instituteProxyService.forwardFileUpload(
      path,
      file,
      body,
      headers,
  ...
  @Post(
    'institutes/:id/courses/:courseId/teacher-modules/:moduleId/contents/upload-file',
  )
  @ApiOperation({
    summary: 'Teacher uploads a file as module content (PDF, document, video)',
  })
  @ApiConsumes('multipart/form-data')
  @UseInterceptors(FileInterceptor('file'))
  ...
  async proxy(@Req() req: Request, @Body() body: any, @Headers() headers: any) {
    ...
    return this.instituteProxyService.forwardRequest(
      relativePath,
      method,
      body,
      headers,
