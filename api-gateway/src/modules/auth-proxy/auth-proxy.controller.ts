...
export class AuthProxyController {
  ...
  @Get('institutes')
  @ApiOperation({
    summary: 'Get current user institutes (proxied to SaaS service)',
  })
  ...
  @Get('institutes/:id')
  @ApiOperation({
    summary: 'Get institute details by ID (proxied to SaaS service)',
  })
  ...
  @ApiOperation({
    summary: 'Update institute plan and features (proxied to SaaS service)',
  })
  ...
  @ApiOperation({
    summary: 'Toggle institute user status (proxied to SaaS service)',
  })
  ...
  @Patch('institutes/:id')
  @ApiOperation({
    summary: 'Update institute details (proxied to SaaS service)',
  })
  ...
  @ApiOperation({
    summary: 'Assign user to institute (proxied to SaaS service)',
  })
  async assignUser(
    @Param('id') id: string,
    @Body() body: any,
    ...
    return this.authProxyService.forwardRequest(
      `auth/institutes/${id}/assign-user`,
      'POST',
      body,
      headers,
    );
  ...
  @ApiOperation({
    summary: 'Remove user from institute (proxied to SaaS service)',
  })
  ...
  @ApiOperation({
    summary: 'Build PayHere checkout params (proxied to SaaS service)',
  })
